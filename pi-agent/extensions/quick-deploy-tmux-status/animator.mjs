...
if (isDirectExecution()) { const socket = process.argv[2]; if (!socket) { console.error("quick-deploy tmux animator: missing socket"); process.exitCode = 2; } else runAnimator({ socketPath: socket }); }
