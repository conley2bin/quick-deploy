...
def main() -> int:
    ...
    parser.add_argument("--option", choices=("script",))
    ...
    actions.add_argument(
        "--registry-query",
        choices=("script-target", "current-name", "current-file", "current-option"),
    )
    ...
    try:
        ...
        if args.prepare:
            ...
            if not args.prepared_script:
                parser.error("--prepare requires --prepared-script")
